      ...
      >
        <div className='flex flex-col gap-y-6 items-center justify-center p-6'>
          ...
          <p className='w-10/12 md:w-9/12 text-center'>
            Have an idea for a project? Need my expertise? or you just want to chat? Feel free to shoot me an
            email!
          </p>
          <Link target='_blank' className='w-fit h-fit relative mt-2' href='mailto:contact@suei.space'>
