...
const Contact = forwardRef((props: any, ref: any) => {
  ...
  return (
    ...
    >
      <section
        className={`w-full md:w-[90%] mx-auto relative flex h-screen md:h-screen items-center justify-center text-primary`}
        ref={ref}
      >
        <div className="flex flex-col gap-y-6 items-center justify-center p-6">
          ...
          <span className="absolute bottom-5 md:bottom-5">
            {" "}
