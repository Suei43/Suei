      ...
      <section className=' w-screen md:w-full h-fit flex items-center justify-center my-20 panel' ref={ref}>
        <div className='w-11/12 md:w-8/12 text-primary flex flex-col justify-center p-6 gap-y-4'>
          ...
          <p className='text-center text-base el'>
            Hello! My name is Folarin Raphael, also known as <span className='text-secondary'>Suei</span>. I
            am a <span className='text-white font-medium'>FullStack Software Engineer</span>,{" "}
            <span className='text-white font-medium'>Smart Contract Developer</span> and an{" "}
          ...
          <p className='text-center text-base el'>
            ...
            the most pronounced tech niches before realizing my passion for building web applications. I have
            had the privilege of working with some amazing teams and companies including{" "}
            <Link href={""}>a startup</Link>, <Link href={""}>an agri-tech company</Link> and{" "}
          ...
          <p className='text-center text-base el'>
            ...
            am not writing code, I am either binge watching a new anime or endlessly scrolling through stack
            overflow.
          </p>
