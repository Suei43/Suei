...
export default function Contact (){
    return (
        <section className={`relative flex h-screen w-full flex items-center justify-center text-primary`}>
            ...
            <span className="absolute bottom-3 text-sm"> &copy; Folarin Raphael 2023</span>
            </div>
        </section>
    )
}